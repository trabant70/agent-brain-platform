// Core type definitions for Agent Brain
// These are runtime pattern types used by AgentBrainCore for analysis
...
// Re-export from extension-api (excluding Pattern which is defined above)
export { Analyzer } from './extension-api';
...
export interface ASTAnalyzer {
    ...
    analyze(ast: AST, patterns: Pattern[]): Promise<AnalysisResult>;
}
