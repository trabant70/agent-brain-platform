/**
 * Pattern Converter
 * Converts between LearningPattern (rich learning type) and Pattern (runtime analysis type)
 */

import { LearningPattern } from './analyzer';
...
export class PatternConverter {
   ...
   */
  static learningToRuntime(learningPattern: LearningPattern): Pattern {
   ...
   */
  static runtimeToLearning(pattern: Pattern): LearningPattern {
    return {
      id: pattern.id,
      name: pattern.name,
   ...
   */
  static learningArrayToRuntime(learningPatterns: LearningPattern[]): Pattern[] {
