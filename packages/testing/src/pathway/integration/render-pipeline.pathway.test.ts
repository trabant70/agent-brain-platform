...
describe('RENDER_PIPELINE Pathway - Integration', () => {
    ...
    it('should handle date range calculation', () => {
        const events = [
            { id: '1', date: new Date('2025-01-01'), type: 'commit', title: 'First', author: 'A', branch: 'main', location: 'local' },
            { id: '2', date: new Date('2025-06-15'), type: 'commit', title: 'Middle', author: 'A', branch: 'main', location: 'local' },
            { id: '3', date: new Date('2025-12-31'), type: 'commit', title: 'Last', author: 'A', branch: 'main', location: 'local' }
        ];
